...
public enum UserSelectablePropertyTypes {
	...
	Element("Element"), Attribute("Attribute"), Indicator("Indicator"), IndicatorElement("Indicator Element"), Id(
			"XML ID"), ElementReference("Reference Element"), AttributeReference("Reference Attribute"), IdReference(
			"XML ID Reference");
