...
public class AboutDialogController {
	...
	public static final String FXML_FILE = "/re-about-dialog.fxml";
	 ...
	 * 
	 * @param stage
	 *            the stage that will own the new dialog
	 ...
	 *
	 * @param dialogStage
	 *            the dialog stage to assign
	 */
	public void setDialogStage(Stage dialogStage) {
		buildNumberLabel.setText("TODO");
