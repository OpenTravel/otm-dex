...
/**
 * Persists settings for the <code>Repository Viewer</code> application between sessions.
 */
public class UserSettings extends AbstractUserSettings {

	private static final String USER_SETTINGS_FILE = "/.ota2/.rv-settings.properties";
	...
	protected void save(Properties settingsProps) {
		...
		// defaultValues.getLastExampleFolder().getAbsolutePath()
	 ...
	 *
	 * @param lastExampleFolder
	 *            the folder location to assign
	 */
