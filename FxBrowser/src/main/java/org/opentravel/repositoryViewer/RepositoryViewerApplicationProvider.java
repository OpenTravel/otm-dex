...
public class RepositoryViewerApplicationProvider implements OTA2ApplicationProvider {
	...
	private static final OTA2ApplicationSpec spec = new OTA2ApplicationSpec("Repository Viewer",
			"Explore OTA2 repositories.", 10, OTA2LauncherTabSpec.EXPERIMENTAL_TAB, Images.launcherIcon,
			RepositoryViewerApp.class);
