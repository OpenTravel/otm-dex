 ...
 * 
 */
public abstract class OtmModelObject<TL extends TLModelElement> {
	private static final Logger LOGGER = LoggerFactory.getLogger(OtmModelObject.class);
	...
	//
	// public OtmLibraryMember(TLBusinessObject mbr) {
	// super(mbr);
	//
	...
	// if (tlMinor != null)
	// return super.createMinorVersionComponent(new OtmLibraryMember(tlMinor));
	// return null;
	// }
	//
	// /**
	...
	// if (!(source instanceof OtmLibraryMember)) {
	// throw new IllegalStateException("Can only merge objects with the same type");
	// }
	// OtmLibraryMember business = (OtmLibraryMember) source;
