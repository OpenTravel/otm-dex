...
/**
 * OTM Object Node for XSD Simple Types.
 * 
...
public class OtmXsdSimple extends OtmSimpleObjects<XSDSimpleType> implements OtmTypeProvider {
	...
	public OtmXsdSimple(XSDSimpleType tlo, OtmModelManager mgr) {
		super(tlo, mgr);
	}
	 ...
	 */
	@Override
	public OtmXsdSimple getOwningMember() {
		return this;
	}

	@Override
	public XSDSimpleType getTL() {
		return (XSDSimpleType) tlObject;
	}
