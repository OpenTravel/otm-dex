...
public class MessageBuilder {
	...
	private static final ResourceBundle messageBundle = ResourceBundle.getBundle("DexRepositoryViewer-messages",
			Locale.getDefault());
	 ...
	 * 
	 * @param bundle
	 *            the ResourceBundle to use for the message text
	 * @param messageKey
	 *            the message key for which to return the human-readable text
	 * @param messageParams
